<div class=" fixed w-screen h-screen top-0 left-0 bg-black bg-opacity-60  items-center justify-center hidden" id="updateimagesdiv">
   <div style="height:80vh; overflow-y: scroll;"  class="bg-white flex flex-col items-center py-10 w-4/12" >
    ...
    <label for="dropzone-file2" class="flex flex-col items-center justify-center w-10/12 h-80 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
