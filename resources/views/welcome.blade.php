...
<body >
    ...
    <main class="hidden md:flex w-full h-20 justify-evenly items-center border border-gray-300" >
        <h1 class="font-bold text-2xl">Fastshop</h1>
    ...
    @include('store.forpg.welcome.section1')
    <script src="{{asset("js/store/welcome.js")}}"></script>
</body>
</html>